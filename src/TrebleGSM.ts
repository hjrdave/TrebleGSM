...
namespace TrebleGSM {
    ...
    export interface StoreItem<TState = any, TKey = string> extends IParcel<TState, TKey> { };
    export interface DispatchItem<TState = any, TKey = string> extends IParcel<TState, TKey> { };
